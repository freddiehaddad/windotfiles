...
$env:FZF_DEFAULT_OPTS = "--color=fg:#8F9695,fg+:#929284,bg:#0D1112,bg+:#1A2125,hl:#5a7582,hl+:#7692A0,info:#5a7582,marker:#7692A0,prompt:#424B4B,spinner:#5a7582,pointer:#757568,header:#8F9695,border:#424B4B,label:#8F9695,query:#5a7582 --border='sharp' --border-label=' Fuzzy Search ' --border-label-pos='0' --preview-window='border-sharp' --prompt='  ' --marker=' ' --pointer='' --separator='─' --scrollbar='│' --info='right' --height='50%'"
# Starship
