...
Set-PSReadLineOption -Colors @{
        ...
        Operator = "`e[38;2;108;126;117m"          # #6c7e75 - cast_iron (Operator)
        ...
        Member = "`e[38;2;148;133;118m"           # #948576 - tarnish (Identifier)
        Type = "`e[38;2;90;152;160m"              # #5a98a0 - patina (Type)
        Comment = "`e[38;2;138;128;115m"            # #8a8073 - slag (Comment)
        Keyword = "`e[38;2;193;92;66m"            # #c15c42 - rust (Keyword)
        Error = "`e[38;2;193;92;66m"              # #c15c42 - rust (Error)
