$PSStyle.FileInfo.Directory = "`e[38;2;58;90;140m" # #0b55cb - cobalt (Directory)
...
Set-PSReadLineOption -Colors @{
        ...
        Parameter = "`e[38;2;31;104;120m"         # #066679 - patina (Type)
        Command = "`e[38;2;28;84;64m"             # #036836 - verdigris (Function)
        String = "`e[38;2;106;76;8m"              # #6a4c08 - forge_amber (String)
        Number = "`e[38;2;58;90;140m"             # #0b55cb - cobalt (@number)
        Variable = "`e[38;2;31;26;18m"            # #1f1a12 - limestone (@variable)
        Member = "`e[38;2;106;94;80m"             # #6a5e50 - tarnish (Identifier)
        Type = "`e[38;2;31;104;120m"              # #066679 - patina (Type)
